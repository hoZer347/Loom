...
namespace Loom
{
	...
	void TCPServer::Update()
	{
		...
		else
		{
			...
			if (path.contains(".."))
			{
				std::cerr << "Requested path contained \"..\", ending request out of abundance of caution" << std::endl;
				return;
			};
		...
		else if (path.ends_with(".data.gz") || path.ends_with(".framework.js.gz"))	content_type = "application/octet-stream";
